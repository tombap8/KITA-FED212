                ...
                // 검사결과 통과이면 ///////////////////
                    ...
                    ******************************/
                    ...
                    $.ajax({
                        ...
                        dataType: "html",
                        // 5.비동기옵션
                        // 비동기 옵션을 끄는 것(false)의 의미는
                        // 현재 JS파일과 동기화를 하여 전역변수값인
                        // pass를 업데이트 해야 하므로 이것을 false로
                        // 설정해야 제대로된 유효성 검사 결과가 나온다!
                        // 만약 true로 하면 pass="false"가 설정안되기때문에
                        // 사용중인 ID일 경우에도 데이터가 입력되는 문제가
                        // 발생된다! (경고창이 콘솔에 떠도 false로 쓸것!)
                        async: false,
